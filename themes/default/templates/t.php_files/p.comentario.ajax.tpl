                                ...
                                <div class="col-md-3">
									 ...
									 <div class="troll" style="z-index: 99;">
										<a href="{$tsConfig.url}/perfil/{$c.user_name}">
											<img title="Avatar de {$c.user_name} en {$tsConfig.titulo}" src="{$tsConfig.url}/files/avatar/{$c.c_user}_120.jpg" class="avatar-48 lazy" style="position: relative; z-index: 1; display: inline;">
										</a>
									...
									<div class="comment-box" id="pp_{$c.cid}" {if $c.c_status == 1 || !$c.user_activo && $tsUser->is_admod}style="opacity:0.5"{/if} >
										...
										<div class="comment-info clearbeta">
											<div class="floatL">
                                                ...
                                                {if $tsUser->is_admod}
                                                <a href="{$tsConfig.url}/moderacion/buscador/1/1/{$c.c_ip}" class="ipComentPost" target="_blank">{$c.c_ip}</a>
                                                {/if}
											</div>
											{if $tsUser->is_member}
											<div style="float:right;margin-top:-21px;" class="floatR answerOptions" id="opt_{$c.cid}">
												<ul id="ul_cmt_{$c.cid}">
