$(document).ready(function(){
	...
	if (typeof $.browser.msie != 'undefined' && $.browser.version == '6.0') $('li.local-file > div.mini-modal').html('<div class="dialog-m"></div><span>Esta funciÃƒÂ³n no es compatible con su navegador</span>');
	...
	upload: function (obj) {
		if ($(obj).hasClass("local")) {
			if ($('input#file-avatar').val()) {
				...
				} else alert('El archivo no es una imagen vÃ¡lida.');
			}
